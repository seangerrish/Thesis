 ...
 \begin{itemize}
   ...
   \begin{itemize}
     ...
     \item Labels from Amazon Mechanical Turk workers 
       \tiny \textcolor{gray}{\cite{chang:2009}} \normalsize
     \item Correlates of War and Issue Correlates of War
       \tiny \textcolor{gray}{\cite{sarkees:2010,hensel:2001}} \normalsize
   \end{itemize}
...
\frame {
 ...
 \begin{eqnarray*}
  ...
  \textcolor{red}{x_{c_2,d}} ) & = & \textcolor{blue}{x_{c_1,d}}^T \textcolor{red}{x_{c_2,d}} \nonumber \\
 \end{eqnarray*}
}

\frame {
\frametitle{Link functions $\mathcal{F}$}
  \center
\small
\begin{tabular}{ll}
%      \hline
      \textbf{Description} & \textbf{$\mathcal{F}(\bm x_1, \bm x_2)$} \\
      \hline
      \hline
      distance & $-\log(|| \bm z_{1} - \bm
      z_{2} ||_2^2 + 1)$ \\
      inner product & $\bm z_{1}^T \bm z_{2}$ \\
      intercept & $y_1 + y_2$ \\ 
...
%   a Spearman rank correlation coefficient of \textbf{$\sigma=0.900$}.
