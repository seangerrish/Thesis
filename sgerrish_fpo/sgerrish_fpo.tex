...
\frame {
 ...
 \item Randomly select 3607 paragraphs discussing pairs of 245
  ...
  \item Hold out 42 random pairs of countries (244 paragraphs) for
    testing. \\
  \item Fit sentiment model parameters $\beta$ on the training
    paragraphs. \\
...
\frame {
  \frametitle{Interesting directions}
  We've talked about some new models for finding patterns in collections of text data:
  \begin{itemize}
  \item A method to map the interactions of countries through time
  \item A way to discover the issues driving lawmakers' votes
  \end{itemize}
}
