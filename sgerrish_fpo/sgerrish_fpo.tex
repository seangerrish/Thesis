 ...
 \begin{itemize}
   ...
   \begin{itemize}
     \item Labels from Amazon Mechanical Turk workers 
       \tiny \textcolor{gray}{\cite{chang:2009}} \Large
     \item Correlates of War and Issue Correlates of War
       \tiny \textcolor{gray}{\cite{sarkees:2010,hensel:2001}} \Large
   \end{itemize}
...
\frame {
  ...
  \normalsize
  \begin{itemize}
  \item The \emph{Correlates of War} \\
    ...
    \vspace{1cm}
  \item The \emph{Issue Correlates of War} \\
    \emph{is a research
...
% \hspace{-36pt}
% \begin{tabular}{cc}
    \includegraphics[width=0.4\textwidth]{figs/mturk_sample_words.pdf}
