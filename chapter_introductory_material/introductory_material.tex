...
\myfig{bagofwords_lda_gm} (right), for example, the corresponding
factorization is
\begin{align}
...
More formally, we can say that the matrix $\{V\}_{ud}$ of boolean
...
We have not yet described the downfall to variational inference: with
