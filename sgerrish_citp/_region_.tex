\message{ !name(sgerrish_citp.tex)}\documentclass{beamer}
...
\message{ !name(sgerrish_citp.tex) !offset(-3) }
...
\frame{
  ...
  Markov step:
  $\beta_{t,k} = \beta_{t-1,k} \textcolor{red}{ + \sum_D \mbox{Infl}(d, z, w)} + \varepsilon $
  \vspace{30pt}
  \newline
...
\message{ !name(sgerrish_citp.tex) !offset(-2247) }
