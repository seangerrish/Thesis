...
x_{c_1}, \bm x_{c_2})$ These were:
\begin{align}
  \begin{array}{cc}
    \mathcal{F}(\bm x_1, \bm x_2) = &
    \begin{tabular}{lll}
...
would require $\bar \bm x_c$ for that country to have large magnitude,
and for other countries to have $\bar \bm x_c$ with large magnitude
