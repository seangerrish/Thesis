...
\myeq{sentiment_text} with a Gaussian prior on $\beta$) on a subset
...
CoW-labeled paragraphs in \myfig{fr_example_betas} (right).
...
\mysec{fr_latent_space_model}, which model nations' pairwise
