...
%In this paper, we make the following contributions.  We propose a
% generative model for identifying and qualifying important documents
% in a corpus.  We describe inference for this model and provide an
% intuitive interpretation of the generative process.  We also provide
% the reader with a tool for viewing these documents in the context of
% a corpus's topics.
...
% our unsupervised model for determining the influence of a document
% using the changes in language used by documents over time.  This is
% followed by experiments to both compare this model with citation
% counts on three well-known corpora and to provide the reader with an
