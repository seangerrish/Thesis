...
An additional contribution of this chapter is that we will also motivate an alternative algorithm for variational inference (which we fully describe in \myapp{stochastic_variational_optimization}) that will allow practitioners to iterate more quickly with their modeling assumptions.

\section{A model of exceptional voting patterns}
%\pagecolor{yellow}
\label{sec:exceptional_model}

\subsection{Limitations of ideal point models.}
...
this, as illustrated in \myfig{moving_ideal_points}; for
