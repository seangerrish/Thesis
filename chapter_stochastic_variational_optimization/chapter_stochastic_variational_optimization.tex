...
%    \setlength{\topsep}{1pt}
	...
	using Equation~\ref{equation:svo_gradient}.
        \setlength{\itemsep}{4pt}
      \STATE Update $\theta$, using Equation~\ref{equation:svo_update}:
        \vspace{-5pt}
	\begin{align*}
          \theta_n \gets \theta_{n-1} -
...
\normalsize
  \caption{First-order SVO (left) and second-order SVO (right). In each, we begin with a variational distribution
    ...
    \label{figure:first_order_algorithm}
\end{figure}
